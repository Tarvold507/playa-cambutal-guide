...
const EventCalendar = () => {
  ...
  // Demo events with location, host, and images
  const events = [
    { 
    ...
    { 
      ...
      location: "Playa Cambutal - North End",
      host: "Cambutal Environmental Group",
    ...
    { 
      ...
      location: "Village Center Plaza",
      host: "Local Fishermen's Association",
    ...
    { 
      ...
      location: "Protected Beach - East Side",
      host: "Marine Conservation Panama",
      image: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
    },
    { 
      ...
      location: "Sunset Bar & Grill",
      host: "Local Musicians Guild",
      image: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
    },
    { 
    ...
    { 
      ...
      location: "Marina Cambutal",
      host: "Anglers Association of Cambutal",
      image: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
    },
    { 
      ...
      location: "Artist's Point - Beach Studio",
      host: "Cambutal Artists Collective",
    ...
    { 
      ...
      location: "Wildlife Reserve - Multiple Locations",
      host: "EcoTours Panama",
      image: "https://images.unsplash.com/photo-1472396961693-142e6e269027?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
    },
    { 
      ...
      location: "Beachfront Stables",
      host: "Sunset Rides Cambutal",
  ...
  const handleReminderChange = (event: any) => {
    if (!isLoggedIn) {
      // Show login prompt
      alert('Please log in or sign up to set event reminders. This feature will be available once you connect to Supabase authentication.')
      return
    }
    
    setReminderChecked(!reminderChecked)
    // TODO: When Supabase is connected, save reminder to user profile
