    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Welcome to Playa Cambutal</h2>
          <p className="text-gray-600 mb-4">
            Nestled on Panama's Pacific coast, Playa Cambutal is a horseshoe-shaped bay known for its consistent waves, 
          ...
          <p className="text-gray-600">
            ...
            you need to make the most of your Playa Cambutal experience.
          </p>
        </div>
      </section>
