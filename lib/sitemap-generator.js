...
// Netlify serves all pages with trailing slashes; sitemap URLs must match.
  ...
  try {
    ...
    if (hotelError) {
      ...
      hotels.forEach(hotel => {
        urls.push({
          loc: sitemapUrl(`/stay/${hotel.slug}`),
    ...
    if (restaurantError) {
      ...
      restaurants.forEach(restaurant => {
        urls.push({
          loc: sitemapUrl(`/eat/${restaurant.slug}`),
